...
/*  Created On : 20-Aug-2017 11:47:02 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	...
	`timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`requisite` VARCHAR(550) NULL,
	`support_legal` VARCHAR(550) NULL,
	`justification` VARCHAR(550) NULL,
	`evidence` VARCHAR(550) NULL,
	`help` VARCHAR(550) NULL,
