...
/*  Created On : 03-Aug-2017 5:28:14 AM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
COMMENT = '    - Usuario     - Experto  //Anterior     - Básico     - Medio     - Avanzado'
...
(
	...
	`timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`points` INT NOT NULL DEFAULT 0 COMMENT 'Puntos del usuario: Representa el número de puntos que tiene el usuario (evaluador, intitution)',
...
ALTER TABLE `service` 
 ADD CONSTRAINT `FK_service_level_service`
	FOREIGN KEY (`id_level`) REFERENCES `level_service` (`id`) ON DELETE Restrict ON UPDATE Restrict
;
